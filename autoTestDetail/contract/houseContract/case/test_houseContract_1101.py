...
def test_1101():
    ...
    # result：1、合同状态变为正退；2、终止结算提交成功

    fileName = 'apartmentContract_1101'
    ...
    with Base() as base:
        ...
        base.diffAssert(lambda test: asserts(sqlbase.waitData(contractEndAdd, 1)).is_true(), 1101,
        ...
        base.diffAssert(lambda test: asserts(contractStatus).is_equal_to('RETREATING'), 1101,
